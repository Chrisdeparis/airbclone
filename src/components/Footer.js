      ...
      <Grid container spacing={3}>
        <Grid item sm={3}>
          <div className="footer">
            ...
            <ul>
              <li className="footer__lien">
                <a href="/">Fonctionnement d'Airbnb</a>
              </li>
              <li className="footer__lien">
                <a href="/">Newsroom</a>
              </li>
              ...
              <li className="footer__lien">
                <a href="/">Lettre des fondateurs</a>
              </li>
            </ul>
          </div>
        </Grid>
        <Grid item sm={3}>
          <h3 className="footer__title">COMMUNAUTÉ</h3>
          <ul>
            <li className="footer__lien">
            ...
            <li className="footer__lien">
              <a href="/">Partenaires Airbnb</a>
            </li>
            <li className="footer__lien">
              <a href="/">Logements d'urgence</a>
            </li>
            <li className="footer__lien">
              <a href="/">Parrainage de voyageurs</a>
            </li>
            <li className="footer__lien">
              <a href="/">Airbnb.org</a>
            </li>
        ...
        <Grid item sm={3}>
          <h3 className="footer__title">HÔTE</h3>
          <ul>
            <li className="footer__lien">
            ...
            <li className="footer__lien">
              <a href="/">Organiser une expérience</a>
            </li>
            <li className="footer__lien">
              <a href="/">Accueil responsable</a>
            </li>
            <li className="footer__lien">
        ...
        <Grid item sm={3}>
          ...
          <ul>
            ...
            <li className="footer__lien">
              <a href="/">Service d'aide aux voisins</a>
            </li>
            <li className="footer__lien">
